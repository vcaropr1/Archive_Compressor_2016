...
CRAM_ONLY_ERRORS=$(grep -F -x -v -f $MAIN_DIR/BAM_CONVERSION_VALIDATION/$SM_TAG"_bam.txt" $MAIN_DIR/CRAM_CONVERSION_VALIDATION/$SM_TAG"_cram.txt" | grep -v "No errors found")
